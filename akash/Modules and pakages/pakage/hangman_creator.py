...
class hangman:
    ...
    def guess_the_letter(self):
        ...
        if letter in self.guessed_letters:
            print('You have already guessed the letter. Your guesses: ', ','.join(self.guessed_letters))
            return

        if letter =="":
            print("You didn't enetered any letter")
        ...
        if (len(occurences) == 0):
            ...
            print("oops! your guess was wrong. Attempts remaining is ", self.attempts_remaining)
    ...
    def get_word_status(self):
        ...
        print("Current status: ", ''.join(self.word_status))
