...
class ChordClient:
    ...
    def stabilize(self):
        ...
        # if the successor's predecessor is between this node and its successor, update this node's succesor 
        if self.node_id < successor_predecessor.node_id < self.successor_list[0].node_id:
