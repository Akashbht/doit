...
# 3 "polynomialaddition.c" 2



# 5 "polynomialaddition.c"
struct poly{
    int data;
    struct poly* next;
};
...
struct poly* newnode(int data){
    ...
    temp -> data = data;
    temp-> next = 
# 13 "polynomialaddition.c" 3 4
                 ((void *)0)
# 13 "polynomialaddition.c"
                     ;
    return temp;
...
void printlist(struct poly* head){
    ...
    while(itr!= 
# 25 "polynomialaddition.c" 3 4
               ((void *)0) 
# 25 "polynomialaddition.c"
                    ){
...
struct poly* addpoly(struct poly* p1, struct poly* p2){
    struct poly* res = 
# 59 "polynomialaddition.c" 3 4
                      ((void *)0)
# 59 "polynomialaddition.c"
                          , *itr;
    ...
    while(i<difflength){
        if(res == 
# 74 "polynomialaddition.c" 3 4
                 ((void *)0)
# 74 "polynomialaddition.c"
                     ){
            res = newnode(p1->data);
            itr = res;
            p1 = p1-> next;
