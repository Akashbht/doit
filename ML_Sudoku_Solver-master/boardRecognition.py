    ...
    for i in range(9):
        for j in range(9):
            if finalgrid[i][j].shape[0] == 28:
                ...
                cv2.imwrite(str("D:\\TCSOOPs\\akash_pycharm\\PROJECTS\\ML_Sudoku_Solver-master\\NumberCells\\cell\\"+str(i) +
                                str(j)+".jpg"), img)
...
board = preprocess_image(cv2.imread("D:\\TCSOOPs\\akash_pycharm\\PROJECTS\\ML_Sudoku_Solver-master\\example.png"))
